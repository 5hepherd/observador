...
if(isset($_GET["g"])){
    ...
    $consulta = "SELECT * FROM estudiantes WHERE grupo='".$grado."' ORDER BY `estudiantes`.`nombre` ASC;";
    ...
    while($registro = $resultado->fetch_assoc()){
        ...
        $print .= '<td class="incidencias">'.$registro['faltas'].'</td>';
         $print .= '<td class="incidencias">'.$registro['salidas'].'</td>';
        $print .= '</tr>';
        echo $print;
    };
};
